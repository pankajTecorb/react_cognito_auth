...
const Login = () => {
  ...
  const handleLogin = async (e: any) => {
    ...
    try {
      const response = await fetch('https://aws-cognito-auth-tecorb.onrender.com/api/v1/user/cognito/login', {
        method: 'POST',
        headers: {
      ...
      if (data.code === 200) {
        ...
        localStorage.setItem("AccessToken", data.data.result.AuthenticationResult.AccessToken);
        localStorage.setItem("RefreshToken", data.data.result.AuthenticationResult.RefreshToken);
