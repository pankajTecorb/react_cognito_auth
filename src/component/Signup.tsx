...
const SignUp = () => {
  ...
  const handleSignUp = async (e: any) => {
    ...
    try {
      const response = await fetch('https://aws-cognito-auth-tecorb.onrender.com/api/v1/user/cognito/signUp', {
        method: 'POST',
        headers: {
      ...
      if (data.code === 201) {
        ...
        // Signup successful, handle the response or redirect the user
       // alert(data.message);
